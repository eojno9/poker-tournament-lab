    ...
    <section className="hrc-artifact-shell" data-testid="hrc-artifacts-view">
      <div className="panel stack">
        ...
        <div className="detail-grid hrc-artifact-summary-grid" data-testid="hrc-artifact-summary">
          <ResultDetailItem label="artifact directory" value={summary.directoryExists ? "present" : "not created"} />
          <ResultDetailItem label="items" value={formatHrcArtifactNumber(summary.totalItems)} />
          <ResultDetailItem label="invalid items" value={formatHrcArtifactNumber(summary.invalidItemsCount)} />
          <ResultDetailItem label="reports" value={formatHrcArtifactNumber(summary.reportCount)} />
          <ResultDetailItem label="indexes" value={formatHrcArtifactNumber(summary.indexCount)} />
          <ResultDetailItem label="comparisons" value={formatHrcArtifactNumber(summary.comparisonCount)} />
        </div>
...
function HrcArtifactDetail({ detail }: { detail: HrcDryRunArtifactDetailResponse }) {
  ...
  return (
    <div className="hrc-artifact-detail" data-testid="hrc-artifact-detail">
      <div className="detail-grid">
        <ResultDetailItem label="fileName" value={sanitizeHrcArtifactDisplayText(detail.fileName)} />
        <ResultDetailItem label="kind" value={detail.kind} />
        <ResultDetailItem label="status" value={sanitizeHrcArtifactDisplayText(summary.status ?? "unknown")} />
        <ResultDetailItem label="validatorPass" value={formatHrcArtifactBoolean(summary.validatorPass)} />
        <ResultDetailItem label="privacySafe" value={formatHrcArtifactBoolean(summary.privacySafe)} />
        <ResultDetailItem label="selectedNodeEntry" value={sanitizeHrcArtifactDisplayText(summary.selectedNodeEntry ?? "unknown")} />
        <ResultDetailItem label="warningsCount" value={formatHrcArtifactNumber(summary.warningsCount)} />
        <ResultDetailItem label="errorsCount" value={formatHrcArtifactNumber(summary.errorsCount)} />
        <ResultDetailItem label="mismatchCount" value={formatHrcArtifactNumber(summary.mismatchCount)} />
        <ResultDetailItem label="rawZipCommitted" value={formatHrcArtifactBoolean(summary.safetyFlags.rawZipCommitted)} />
        <ResultDetailItem label="productImportConnected" value={formatHrcArtifactBoolean(summary.safetyFlags.productImportConnected)} />
        <ResultDetailItem label="dbWriteApplied" value={formatHrcArtifactBoolean(summary.safetyFlags.dbWriteApplied)} />
      </div>
